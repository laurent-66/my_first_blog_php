...
<div class=\"container-dashboard\">
    ...
    <div class=\"tab-content\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["comment"]) {
            ...
            // line 43
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["comment"], "commentContent", [], "any", false, false, false, 43), "html", null, true);
            echo "</p></div>
                    <div class=\"col4 mr-3\">
...
";
    ...
    {
        return array (  150 => 52,  139 => 47,  135 => 46,  129 => 43,  126 => 42,  122 => 41,  117 => 38,  108 => 34,  103 => 32,  98 => 31,  96 => 30,  92 => 29,  85 => 25,  81 => 24,  77 => 23,  72 => 20,  68 => 19,  46 => 2,  35 => 1,);
    }
    ...
    <div class=\"tab-content\">
        ...
        <a href=\"/blogs/admin/new\"><button class=\"btn btn-success btn-block mb-3 mx-auto new-blog-button\">Créer un nouveau blog</button></a>
            ...
            <div class=\"row border-top border-dark\">
                <div class=\"line-info-list my-3\">
                    <div class=\"col 10 row-align-start-left\">
                        <div class=\"col4 item-list font-weight-bold\"><p>{{blog.last_update_blog}}</p></div>
                        <div class=\"col4 item-list\"><p>{{blog.title_blog}}</p></div>
                        <div class=\"col4 item-list\"><p>{{blog.chapo_blog}}</p></div>
                    </div>
